...
![Screenshot](https://github.com/realbazzi/rain-claimer/tree/main/assets/screenshot.png)

## 🚀 Installation

1. Downloade das [letzte release](https://github.com/realbazzi/rain-claimer/releases/tag/v2.2) oder klone die Repository und entpacke die *.zip Datei
